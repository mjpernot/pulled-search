...
/usr/bin/python ./test/unit/pulled_search/filter_data.py
/usr/bin/python ./test/unit/pulled_search/file_input.py
...
/usr/bin/python ./test/unit/pulled_search/write_summary.py
