...
### Changed
- process_docid: Create gen_class.ArgParser class instance for the check_log.run_program call and refactored part of the functioni and replaced hardcoding of command check with configuration check.
