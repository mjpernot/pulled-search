...
### Changed
- process_docid: Create gen_class.ArgParser class instance for the check_log.run_program call and refactored part of the function.
...
- config/search.py.TEMPLATE:  Added entry to connect to RabbitMQ cluster and email option entries.
