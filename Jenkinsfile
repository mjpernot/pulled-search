    ...
    stages {
        ...
        stage('Test') {
            steps {
                ...
                dir ('checklog/lib') {
                    git branch: "mod/312", credentialsId: "2cfb403c-be21-4fac-94d7-c8cd5c531feb", url: "https://gitlab.code.dicelab.net/JAC-IDM/python-lib.git"
                }
                sh """
                        ...
                        "files": [
                            {
                                ...
                                "recursive": false,
                                "excludePatterns": [],
                                "target": "generic-local/highpoint/pulled-search/"
                            },
                            {
                                "pattern": "./*.txt",
                                "recursive": false,
                            ...
                            },
                            {
                                ...
                                "recursive": true,
                                "excludePatterns": [],
                                "target": "generic-local/highpoint/pulled-search/config/"
                            }
                        ]
                    }"""
